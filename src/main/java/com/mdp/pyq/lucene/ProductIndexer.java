...
import com.mdp.pyq.pojo.Product;
import com.mdp.pyq.service.ProductService;
...
/** 是howtoJ的Lucene教程: 检索14万条数据
 * https://how2j.cn/k/search-engine/search-engine-14k/1674.html#nowhere
 */
...
public class ProductIndexer {
    ...
    private static void showSearchResults(IndexSearcher searcher, ScoreDoc[] hits, Query query, SmartChineseAnalyzer analyzer) throws Exception {
        ...
        for (int i = 0; i < hits.length; ++i) {
            ...
            for (IndexableField f : fields) { //输出所有field
    ...
    private static Directory createIndex(SmartChineseAnalyzer analyzer) throws IOException {
        ...
        List<Product> products = ProductService.file2list(fileName);
